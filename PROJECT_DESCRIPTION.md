...
2. **A one-time final step** (`experiments/final_submission.py`) that retrains that run's
   winning configuration and scores hidden test exactly once, producing the submission CSV.
